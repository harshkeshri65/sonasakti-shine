    ...
    <footer className="green-gradient text-primary-foreground">
      <div className="container mx-auto px-4 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Wheat className="h-7 w-7 text-gold-light" />
              <span className="font-heading text-2xl font-bold">SONASAKTI</span>
            </div>
            <p className="text-primary-foreground/80 text-sm mb-2">ALOK HARSH RICE MILL PVT. LTD.</p>
            <p className="text-gold-light font-heading italic">Richness in Rice</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/80">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:9931570543" className="hover:text-gold-light transition-colors">9931570543</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 shrink-0 text-gold-light" />
                <a href="mailto:alokharshricemillpvt.ltd@gmail.com" className="hover:text-gold-light transition-colors text-xs break-all">
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20 text-center text-sm text-primary-foreground/60">
          <p>© {new Date().getFullYear()} ALOK HARSH RICE MILL PVT. LTD. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
